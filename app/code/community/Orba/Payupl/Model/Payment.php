      ...
      
{
  ...
  public function _onPaymentStateChange($pmnt, $newState, $oldState)
  {
      if ($newState != $oldState) {
            switch($newState)
            {
              case Orba_Payupl_Model_Payment::PAYMENTSTATE_NEW: $this->_processPaymentChangeNew($pmnt); break;
              case Orba_Payupl_Model_Payment::PAYMENTSTATE_CANCELED: $this->_processPaymentChangeCanceled($pmnt); break;
              case Orba_Payupl_Model_Payment::PAYMENTSTATE_DENIED: $this->_processPaymentChangeDenied($pmnt); break;
              case Orba_Payupl_Model_Payment::PAYMENTSTATE_INPROGRSSS: $this->_processPaymentChangeInProgress($pmnt); break;
              case Orba_Payupl_Model_Payment::PAYMENTSTATE_PENDING: $this->_processPaymentChangePending($pmnt); break;
              case Orba_Payupl_Model_Payment::PAYMENTSTATE_REVERSED: $this->_processPaymentChangeReversed($pmnt); break;
              case Orba_Payupl_Model_Payment::PAYMENTSTATE_COMPLETED: $this->_processPaymentChangeCompleted($pmnt); break;
              case Orba_Payupl_Model_Payment::PAYMENTSTATE_ERROR: $this->_processPaymenChangeError($pmnt); break;
              default: $this->_processPaymentChangeError($pmnt); break;
            }
            try{
